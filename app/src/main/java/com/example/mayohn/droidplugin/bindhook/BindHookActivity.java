package com.example.mayohn.droidplugin.bindhook;
...
public class BindHookActivity extends Activity {
    private Button copy;
...
//        hookClipboard();
        ...
        copy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                info.setText("粘贴板的内容有" + clipData.getItemCount() + "个:" + clipData.getItemAt(0).getText());
            }
        });
